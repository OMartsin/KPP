...
public class MenuUtility {
    private EmployeeCollectionsController controller;
    ...
    public void displayMenu() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    EmployeeCollectionsPrinter.printEmployeeList(employees);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    EmployeeCollectionsPrinter.printEmployeeList(
    ...
    private void loadEmployeesFromSingleFile(Scanner scanner) {
        ...
        try{
            employees = FileReaderUtil.readEmployeeData(filePath);
        }catch (IOException e){
    ...
    private void loadEmployeesFromTwoFiles(Scanner scanner) {
        ...
        try{
            employees = FileReaderUtil.readEmployeeData(filePath1);
            var tempEmployees = FileReaderUtil.readEmployeeData(filePath2);
